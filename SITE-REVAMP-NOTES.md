...
1. **blueprint.html & cascade.html** — only have Pass-1 header/footer. Need the flagship body treatment AND the positioning-note direction: blueprint must show the layered architecture with the **upward feedback loop** as visible as the downward cascade; cascade should follow **one concrete task** through the stops and end at the **write-back moment**.

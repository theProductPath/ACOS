...
Drafting, v0.1. Currently being extracted from tPPOS into its own coherent surface. The first skill — `client-brief-processor` — is live; more will follow as patterns harden inside tPPOS and prove general enough to promote.
...
- `docs/adopting-acos.md` — guide for a new company adopting ACOS. **TODO** — not yet written.
